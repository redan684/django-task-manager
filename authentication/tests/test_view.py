...
class TestViews(TestSetup):
    ...
    def test_cant_register_user_with_invalid_email(self):
        response=self.client.post(reverse('register'),self.user_invalid_email,format='text/html')
        self.assertEqual(response.status_code,200)

    def test_cant_register_user_with_no_username(self):
        response=self.client.post(reverse('register'),self.user_no_username,format='text/html')
        self.assertEqual(response.status_code,200)
